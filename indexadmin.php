                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="/corkexpress/indexadmin.php?an=9"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-briefcase"></i><span class="hide-menu">Empresa</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/corkexpress/indexadmin.php?an=1">Faturação</a></li>
                                <li><a href="/corkexpress/indexadmin.php?an=2">Emitir Salarios</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-certificate"></i><span class="hide-menu">Categoria Profissional</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/corkexpress/indexadmin.php?an=5">Adicionar</a></li>
                                <li><a href="/corkexpress/indexadmin.php?an=6">Listar</a></li>
                            </ul>
                        </li>
